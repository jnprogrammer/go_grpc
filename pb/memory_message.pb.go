...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=cpustats.pcbook.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_message_proto_rawDesc = []byte{
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1c, 0x2e, 0x63, 0x70, 0x75, 0x73, 0x74, 0x61, 0x74,
	0x73, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x2e,
	...
	0x54, 0x45, 0x52, 0x41, 0x42, 0x59, 0x54, 0x45, 0x10, 0x06, 0x42, 0x04, 0x5a, 0x02, 0x2e, 0x2f,
...
var file_memory_message_proto_goTypes = []interface{}{
	(Memory_Unit)(0), // 0: cpustats.pcbook.Memory.Unit
	(*Memory)(nil),   // 1: cpustats.pcbook.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: cpustats.pcbook.Memory.unit:type_name -> cpustats.pcbook.Memory.Unit
