...
type Screen struct {
	...
	Panel      Screen_Panel       `protobuf:"varint,3,opt,name=panel,proto3,enum=cpustats.pcbook.Screen_Panel" json:"panel,omitempty"`
...
var file_screen_message_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x63, 0x70, 0x75, 0x73, 0x74, 0x61, 0x74, 0x73, 0x2e, 0x70,
	...
	0x28, 0x0e, 0x32, 0x1d, 0x2e, 0x63, 0x70, 0x75, 0x73, 0x74, 0x61, 0x74, 0x73, 0x2e, 0x70, 0x63,
...
var file_screen_message_proto_goTypes = []interface{}{
	(Screen_Panel)(0),         // 0: cpustats.pcbook.Screen.Panel
	(*Screen)(nil),            // 1: cpustats.pcbook.Screen
	(*Screen_Resolution)(nil), // 2: cpustats.pcbook.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: cpustats.pcbook.Screen.resolution:type_name -> cpustats.pcbook.Screen.Resolution
	0, // 1: cpustats.pcbook.Screen.panel:type_name -> cpustats.pcbook.Screen.Panel
